...
def SearchAlgorithmVisual():
    ...
    file_name = "./input/level_2/input1.txt"
    ...
    GBFS_bunus_point(WIN, lambda: draw(WIN, grid, ROWS, width, bonus_points), grid, grid[start[0]][start[1]], grid[end[0]][end[1]],matrix, ManhattanDistance, bonus_points)
    createVideo("6.mp4")
